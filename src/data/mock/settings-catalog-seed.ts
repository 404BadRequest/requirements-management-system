...
export const settingsCatalogSeed: SettingsCatalogEntry[] = [
  row("cat-st-backlog", "requirement_status", "BACKLOG",           "Por desarrollar",     0, "gray"),
  row("cat-st-qa",     "requirement_status", "READY_FOR_QA",      "Pasar a QA",          1, "amber"),
  row("cat-st-qadone", "requirement_status", "QA_DONE",           "Listo en QA",         2, "teal"),
  row("cat-st-prod",   "requirement_status", "READY_FOR_PROD",    "Pasar a producción",  3, "orange"),
  row("cat-st-done",   "requirement_status", "DONE_PROD",         "Listo en producción", 4, "green"),
  row("cat-st-wont",   "requirement_status", "WONT_DO",           "No desarrollar",      5, "red"),
  row("cat-st-client", "requirement_status", "CLIENT_VALIDATION", "Validar con cliente", 6, "purple"),
  row("cat-pr-p0", "requirement_priority", "P0", "P0", 0, "red"),
  row("cat-pr-p1", "requirement_priority", "P1", "P1", 1, "orange"),
  row("cat-pr-p2", "requirement_priority", "P2", "P2", 2, "amber"),
  row("cat-pr-p3", "requirement_priority", "P3", "P3", 3, "blue"),
  row("cat-pr-p4", "requirement_priority", "P4", "P4", 4, "teal"),
  row("cat-pr-p5", "requirement_priority", "P5", "P5", 5, "green"),
  row("cat-pr-p6", "requirement_priority", "P6", "P6", 6, "gray"),
